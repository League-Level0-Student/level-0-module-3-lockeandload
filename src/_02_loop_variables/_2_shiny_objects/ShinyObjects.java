...
public class ShinyObjects {
	...
	void manyShinyObjects() {
		...
		String shinycount = JOptionPane.showInputDialog("how many shiny objects do you want?");
		int shiny;
		int shinyCount = Integer.parseInt(shinycount);
		
			for(shiny = 0;shiny < shinyCount;shiny++) {
				playMisterZee();
